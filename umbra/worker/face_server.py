"""Encrypted 64x64 face match. Bind VPC :8084. Never decrypt. No clear net."""
...
from umbra.face_ckks import eval_l2_ciphertext, looks_like_plaintext_face, unpack_face

BIND = os.environ.get("UMBRA_FACE_VPC_IP") or os.environ.get("UMBRA_FHE_VPC_IP") or "10.20.0.7"
PORT = int(os.environ.get("UMBRA_FACE_PORT", "8084"))
MACHINE_ID = (
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        try:
            ...
            out = eval_l2_ciphertext(evk, tmpl, probe)
...
if __name__ == "__main__":
    if BIND in ("0.0.0.0", "::", "127.0.0.1"):
        sys.exit("face must bind VPC IP")
    print(f"face bind {BIND}:{PORT} machine={MACHINE_ID}", flush=True)
